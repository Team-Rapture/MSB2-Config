...
//Items
mods.actuallyadditions.Empowerer.addRecipe(<actuallyadditions:item_crystal_empowered>, <actuallyadditions:item_crystal>, <evilcraft:blood_orb:1>, <extrautils2:ingredients:2>, <minecraft:apple>, <minecraft:red_nether_brick>, 125000, 10,[1,0,0]);
...
//Blocks
mods.actuallyadditions.Empowerer.addRecipe(<actuallyadditions:block_crystal_empowered>, <actuallyadditions:block_crystal>, <evilcraft:blood_orb:1>, <extrautils2:ingredients:2>, <minecraft:apple>, <minecraft:red_nether_brick>, 12500000, 1000,[1,0,0]);
